...
<script>
    $(document).ready(function() {
        var baseUrl = "<?php echo e(route('contact-informations.index')); ?>"
        ...
        $(document).on('click', '#create-new-info', function(ev) {
            ...
            $('#contact-info').modal('show');
             ...
             $('#contact-info-form').append('<input type="hidden" id="url"  value="'+'<?php echo e(route('contact-informations.store')); ?>'+'" />');
        });
        $(document).on('click', '.contact-edit', function(ev) {
            ...
            $('#type').val('edit');
              var mt = '<?php echo method_field('put '); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/sraj/Sites/test-pro/resources/views/contact-information/index.blade.php ENDPATH**/ ?>